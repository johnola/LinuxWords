...
public class NutPad extends JFrame {
    ...
    public NutPad() {
        ...
        JMenu fileMenu2 = menuBar.add(new JMenu("Help"));
        ...
        fileMenu2.add(_aboutAction);       // Note use of actions, not text.
   
        fileMenu2.addSeparator(); 
        fileMenu2.add(_exitAction);
    ...
    class aboutAction extends AbstractAction  {
    	...
    	public void actionPerformed(ActionEvent e) {
    		...
    		JOptionPane.showMessageDialog(NutPad.this,"This is Olayinka");
    		//_editArea.setText("This is Olayinka");
        }
